...
const ServicesPage = () => {
  ...
  return (
    <main>
      <section>
        <TextHeading 
          text="Services — I create innovative web designs in Figma and bring them to life with expert frontend development. Through clean and efficient code, I build high-performance websites tailored to your business needs." 
