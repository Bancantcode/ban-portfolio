...
const ServicesPage = () => {
  ...
  return (
    <main>
      <section>
        <TextHeading 
          text="Services — I create innovative web designs in Figma and bring them to life with expert frontend development. Through clean, efficient code, I build high-performance websites tailored to your business needs. My focus is on crafting engaging, user-friendly experiences that captivate audiences and drive growth." 
        ...
        <div className="flex gap-1 col-start-8 col-span-5">
          <a href="/projects"><Button id="nav-btn" title="My Work" containerClass="" /></a>
          <a href="/contact"><Button id="nav-btn" title="Book a free discovery call" containerClass="" /></a>
        </div>
