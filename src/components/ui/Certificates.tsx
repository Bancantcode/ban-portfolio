  ...
  return (
    <div className='flex flex-col md:gap-12 gap-sm items-center py-3xl justify-center relative overflow-hidden'>
      ...
      <div className='flex flex-col items-center section-x-padding'>
        <TextReveal text={certificate.title} className="text-heading-2 md:text-heading-1 lg:text-heading-display leading-none uppercase font-medium mb-xs" marginRight="mr-0" />
