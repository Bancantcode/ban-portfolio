          ...
          <div className="relative flex items-center" key={index}>
            <div className="group relative flex items-center">
              <span className='bg-semi-dark text-light-violet rounded-[0.4rem] border border-violet lg:p-2 p-1.5 relative group hover:shadow-xl hover:shadow-violet transition-all duration-300 ease-in-out hover:border-[#6C59B9] hover:bg-[#221D36] cursor-help'>
                <Image src={exp.icon} alt={exp.tooltip} width={32} height={32} className='w-6 h-6 lg:w-10 lg:h-10 xl:w-10 xl:h-10' />
              </span>
              <div className={`absolute text-xs bg-semi-dark text-white lg:px-2 px-1.5 lg:py-1.5 py-1 z-50 rounded-md opacity-0 group-hover:opacity-100 text-nowrap transition-opacity duration-300 ease-in-out top-[120%] left-[50%] transform translate-x-[-50%] pointer-events-none border border-light-violet z-99`}>
                {exp.tooltip}
              </div>
            </div>
          </div>
