    ...
    return (
        <div className="section-x-padding pt-xl md:pt-3xl pb-xl md:pb-3xl">
            ...
            <div className="grid-style2 mb-xl xl:mb-3xl">
                <TextReveal text="See — My Projects" className="text-heading-1 lg:text-heading-display 2xl:text-heading-display-large lg:w-4/5 leading-none uppercase font-medium mb-md col-span-4 md:col-span-6 md:col-start-4 lg:col-start-3 lg:col-span-8 2xl:col-start-3 2xl:col-span-10" marginRight="mr-2 lg:mr-3" />
