...
const TextHeading: React.FC<TextHeadingProps> = ({ text, description }) => {
  ...
  return (
    <section className="grid-style section-x-padding py-xl md:py-3xl">
      ...
      <TextReveal text={description} className="text-style col-start-1 col-span-12 md:col-start-6 md:col-span-5 lg:col-start-7 lg:col-span-6 xl:col-start-8" marginRight="mr-1" />
